                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('Enter your Envato Market referral link to the Quform Landing Page, for example: %s', 'quform'), '<code>https://1.envato.market/qqmKb</code>'); ?></p>
                            </div>
                        </div>
                    </div>
